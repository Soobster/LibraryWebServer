    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult AllTitles()
        {
            ...
            using (Team84LibraryContext db = new Team84LibraryContext())
            {
                ...
                into titlesAndInven
                from j1 in titlesAndInven.DefaultIfEmpty()

                join c in db.CheckedOut
                on j1.Serial equals c.Serial
                into CheckedAndSerial
                from j2 in CheckedAndSerial.DefaultIfEmpty()

                join p in db.Patrons
                on j2.CardNum equals p.CardNum
                into PatronNames
                from j3 in PatronNames.DefaultIfEmpty()
        ...
        public ActionResult ListMyBooks()
        {
            ...
            using (Team84LibraryContext db = new Team84LibraryContext())
            {
                ...
                var query =
                    ...
                    into CheckedAndInven
                    from j1 in CheckedAndInven

                    join t in db.Titles
                    on j1.Isbn equals t.Isbn
                    into CheckedBooks
                    from j2 in CheckedBooks
